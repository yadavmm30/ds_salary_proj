...
def get_jobs(keyword, num_jobs, verbose, path, sleep_time):
    ...
    while len(jobs) < num_jobs:  # If true, should be still looking for new jobs.
        ...
        try:
            driver.find_element(By.CSS_SELECTOR, '[class="e1jbctw80 ei0fd8p1 css-1n14mz9 e1q8sty40"]').click()  # clicking to the X.
        ...
        job_buttons = driver.find_element(By.CLASS_NAME, "hover p-0 my-0  css-7ry9k1 exy0tjh5")  # jl for Job Listing. These are the buttons we're going to click.
        print("step2")
        print(job_buttons)
